...
// Payment System
  payment: {
    ...
    rechargeRateBadge: '1 {currency} = {amount} {unitName} credit',
    selectSubscriptionPlan: 'Choose Your Subscription Plan',
    selectedPlan: 'Selected plan',
    enterAmountWithMinimum: 'Enter amount (minimum {min} {currency})',
