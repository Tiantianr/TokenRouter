    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Invite rebates use the order plan price for subscriptions and the credited balance for balance top-ups.',
          ...
          rebateRateHint: 'Rate: 0-100. Subscriptions use the price recorded at checkout, not plan quota; balance top-ups use credited balance. A plan priced at 80 earns 8 account credits at 10%, excluding payment fees and currency conversion.',
