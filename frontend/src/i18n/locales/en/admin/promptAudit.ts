export default {
  promptAudit: {
    sessions: {
      previous: 'Previous',
      next: 'Next page',
      sessionId: 'Session ID', manage: 'Manage session events',
      title: 'Session evidence', description: 'Browse detection records by user and session. Open a session, then select View evidence to inspect findings and download the full context. Ordinary passing evidence lasts seven days; selected users’ passing evidence and risk evidence are retained indefinitely.',
      back: 'Back to sessions', counts: 'Events / Risks / Evidence', lastSeen: 'Last activity', open: 'Open session', evidence: 'Full context',
      available: 'Available', unavailable: 'Not retained or expired', view: 'View evidence', empty: 'No sessions or detection records', loadFailed: 'Could not load session evidence. Please retry.'
    },
    title: 'Prompt Audit',
    ...
    policy: {
      ...
      blockingExemptUsers: 'Blocking-exempt users', blockingExemptUsersHint: 'These users are fully audited and events are recorded without blocking by Prompt Audit. Existing content moderation remains independent; deep-review state and extraction errors retain their safety policy.', blockingExemptUserCount: '{count} blocking-exempt users selected, up to 100',
    ...
    cleanup: {
      ...
      userScope: 'User scope', allUsers: 'All users', selectedUser: 'Selected user', userRequired: 'Select one user.', matched: '{count} normal events match', contexts: 'Complete conversations', estimatedBytes: 'Estimated evidence reclaimed', estimateHint: 'This estimates stored evidence. Built-in logical backups omit content tables; cleanup does not guarantee immediate disk space reclamation.', previewRequired: 'Generate a server preview before confirming.', confirm: 'Clean normal events',
    },
