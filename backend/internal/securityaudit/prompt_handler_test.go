...
// 测试替身显式覆盖会话管理接口，避免接口扩展后遗漏装配校验。
func (f *fakePromptAdminService) ListSessions(context.Context, *int64, int, int) (*SessionPage, error) {
	return &SessionPage{Items: []SessionSummary{}}, nil
}
